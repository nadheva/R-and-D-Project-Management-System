    ...
    <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->role == 'admin')
                ...
                {{-- Task --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('task.*') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Loading Allocation</span>
                    </a>
                </li>
                {{-- PROJECT --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('project.*') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Project Status</span>
                    </a>
                </li>
                {{-- RIO --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('rio.*') ? 'active' : '' }}"
                        href="{{ route('rio.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Project RIO</span>
                    </a>
                </li>
                <li class="nav-item mt-3">
                    <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Add To Database</h6>
                </li>
                <li class="nav-item">
                ...
                {{-- RIO --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('model.*') ? 'active' : '' }}"
